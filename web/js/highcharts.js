...
(function (M, S) {
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      dSetter: function () {
        ...
        t;
        if (1 === r) l = this.toD;
         else if (u === f.length && 1 > r) for (; u--; ) t = parseFloat(a[u]),
        l[u] = isNaN(t) ? a[u] : r * parseFloat(f[u] - t) + t;
         else l = f;
      ...
      initPath: function (m, f, l) {
        function r(a) {
          var c,
          e;
          for (n = a.length; n--; ) c = 'M' === a[n] || 'L' === a[n],
          e = /[a-zA-Z]/.test(a[n + 3]),
          c && e && a.splice(n + 1, 0, a[n + 1], a[n + 2], a[n + 1], a[n + 2])
        }
        function u(a, c) {
          for (; a.length < v; ) {
            a[0] = c[v - a.length];
        ...
        function t(a, c) {
          for (var q = (v - a.length) / e; 0 < q && q--; ) y = a.slice().splice(a.length / J - e, e * J),
          y[0] = c[v - e - q * e],
          b && (y[e - 6] = y[e - 2], y[e - 5] = y[e - 1]),
          [
          ].splice.apply(a, [
            a.length / J,
            0
        ...
        b && (r(f), r(l));
        if (d && k) {
          for (n = 0; n < d.length; n++) if (d[n] === k[0]) {
            g = n;
            break
    ...
    a.merge = function () {
      ...
      u = function (f, g) {
        ...
        a.objectEach(g, function (d, k) {
          !a.isObject(d, !0) || a.isClass(d) || a.isDOMElement(d) ? f[k] = g[k] : f[k] = u(f[k] || {
          }, d)
        });
        return f
      };
    ...
    a.pick = function () {
      ...
      l,
      r = a.length;
      for (f = 0; f < r; f++) if (l = a[f], void 0 !== l && null !== l) return l
    };
    a.css = function (m, f) {
    ...
    a.getTZOffset = function (m) {
      var f = a.Date;
      return 60000 * (f.hcGetTimezoneOffset && f.hcGetTimezoneOffset(m) || f.hcTimezoneOffset || 0)
    };
    a.dateFormat = function (m, f, l) {
      ...
      r = a.extend({
        ...
        P: 12 > t ? 'am' : 'pm',
        S: n(u.getSeconds()),
        L: n(Math.round(f % 1000), 3)
      }, a.dateFormats);
      a.objectEach(r, function (a, e) {
        for (; - 1 !== m.indexOf('%' + e); ) m = m.replace('%' + e, 'function' === typeof a ? a(f) : a)
      });
    ...
    a.getStyle = function (m, f, l) {
      ...
      if (m = E.getComputedStyle(m, void 0)) m = m.getPropertyValue(f),
      a.pick(l, !0) && (m = a.pInt(m));
      return m
    };
    a.inArray = function (a, f) {
      return f.indexOf ? f.indexOf(a) : [
      ].indexOf.call(f, a)
    };
    a.grep = function (a, f) {
    ...
    a.map = function (a, f) {
      for (var l = [
      ], r = 0, m = a.length; r < m; r++) l[r] = f.call(a[r], a[r], r, a);
      return l
    };
    a.offset = function (a) {
    ...
    a.addEvent = function (m, f, l) {
      ...
      m.addEventListener ? m.addEventListener(f, l, !1) : m.attachEvent && (m.hcEventsIE || (m.hcEventsIE = {
      }), l.hcGetKey || (l.hcGetKey = a.uniqueKey()), m.hcEventsIE[l.hcGetKey] = r, m.attachEvent('on' + f, r));
      u[f] || (u[f] = [
      ]);
      u[f].push(l);
      return function () {
    ...
    a.removeEvent = function (m, f, l) {
      ...
      function u() {
        ...
        b;
        m.nodeName && (f ? (d = {
        }, d[f] = !0) : d = g, a.objectEach(d, function (a, d) {
          if (g[d]) for (b = g[d].length; b--; ) r(d, g[d][b])
        }))
      }
      var t,
      g = m.hcEvents,
      d;
      g && (f ? (t = g[f] || [
      ], l ? (d = a.inArray(l, t), - 1 < d && (t.splice(d, 1), g[f] = t), r(f, l)) : (u(), g[f] = [
      ])) : (u(), m.hcEvents = {
      }))
    };
    a.fireEvent = function (m, f, l, r) {
      ...
      if (F.createEvent && (m.dispatchEvent || m.fireEvent)) u = F.createEvent('Events'),
      u.initEvent(f, !0, !0),
      a.extend(u, l),
      m.dispatchEvent ? m.dispatchEvent(u) : m.fireEvent(f, u);
       else if (u) for (u = u[f] || [
      ], t = u.length, l.target || a.extend(l, {
    ...
    a.seriesType = function (m, f, l, r, u) {
      ...
      g[m] = a.extendClass(g[f] || function () {
      }, r);
    ...
    F && !F.defaultView && (a.getStyle = function (m, f) {
      ...
      'opacity' === f && (f = 'filter');
      if (l) return m.style.zoom = 1,
      Math.max(m[l] - 2 * a.getStyle(m, 'padding'), 0);
    ...
    Array.prototype.forEach || (a.each = function (a, f, l) {
      for (var r = 0, m = a.length; r < m; r++) if (!1 === f.call(l, a[r], r, a)) return r
    });
    Array.prototype.indexOf || (a.inArray = function (a, f) {
      var l,
      r = 0;
      if (f) for (l = f.length; r < l; r++) if (f[r] === a) return r;
      return - 1
    });
    Array.prototype.filter || (a.grep = function (a, f) {
      for (var l = [
      ], r = 0, m = a.length; r < m; r++) f(a[r], r) && l.push(a[r]);
      return l
    });
    Array.prototype.find || (a.find = function (a, f) {
      var l,
      r = a.length;
      for (l = 0; l < r; l++) if (f(a[l], l)) return a[l]
    })
  }) (M);
  (function (a) {
    var C = a.each,
    ...
    a.Color.prototype = {
      ...
      init: function (f) {
        ...
        if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ''] || f) && f.stops) this.stops = F(f.stops, function (g) {
         ...
         else if (f && '#' === f.charAt() && (l = f.length, f = parseInt(f.substr(1), 16), 7 === l ? r = [
          (f & 16711680) >> 16,
          (f & 65280) >>
          8,
          f & 255,
          ...
          (f & 15) << 4 | f & 15,
          1
        ])), !r) for (m = this.parsers.length; m-- && !r; ) t = this.parsers[m],
        (l = t.regex.exec(f)) && (r = t.parse(l));
        this.rgba = r || [
        ]
      },
      get: function (a) {
        ...
        r = this.rgba,
        m;
        this.stops ? (m = E(f), m.stops = [
        ].concat(m.stops), C(this.stops, function (f, g) {
          m.stops[g] = [
            m.stops[g][0],
            f.get(a)
          ]
      ...
      brighten: function (a) {
        ...
        if (this.stops) C(this.stops, function (f) {
         ...
         else if (A(a) && 0 !== a) for (f = 0; 3 > f; f++) r[f] += m(255 * a),
        0 > r[f] && (r[f] = 0),
        255 < r[f] && (r[f] = 255);
        return this
      },
  ...
  (function (a) {
    ...
    e(C.prototype, {
      ...
      colorGradient: function (x, h, c) {
        ...
        q && (N = x[q], n = w.gradients, k = x.stops, v = c.radialReference, J(N) && (x[q] = N = {
          ...
          z.push(a)
        }), z = z.join(','), n[z] ? v = n[z].attr('id') : (N.id = v = a.uniqueKey(), n[z] = g = w.createElement(q).attr(N).add(w.defs), g.radAttr = d, g.stops = [
        ], b(k, function (x) {
      ...
      applyTextOutline: function (x) {
        ...
        if ((p = x[0]) && 'none' !== p && a.svg) {
          ...
          for (q = x.length; q--; ) c = x[q],
          'highcharts-text-outline' === c.getAttribute('class') && v(x, h.removeChild(c));
          e = h.firstChild;
          b(x, function (a, x) {
      ...
      attr: function (a, h, c, w) {
        ...
        b,
        N;
        'string' === typeof a && void 0 !== h && (x = a, a = {
        }, a[x] = h);
      ...
      align: function (a, h, c) {
        ...
        d;
        if (a) {
          if (this.alignOptions = a, this.alignByTranslate = h, !c || B(c)) this.alignTo = x = c || 'renderer',
          v(p, this),
          p.push(this),
          c = null
      ...
      getBBox: function (a, h) {
        ...
        w = h * g;
        d = q && q.fontSize;
        void 0 !== n && (G = n.toString(), - 1 === G.indexOf('<') && (G = G.replace(/[0-9]/g, '0')), G += [
          '',
          h || 0,
          d,
          q && q.width,
        ...
        if (!x) {
          ...
          if (G && 0 < x.height) {
            for (; 250 < H.length; ) delete N[H.shift()];
            N[G] || H.push(G);
            N[G] = x
          }
        }
      ...
      destroy: function () {
        ...
        a.safeRemoveChild(h);
        for (a.destroyShadows(); c && c.div && 0 === c.div.childNodes.length; ) h = c.parentGroup,
      ...
      shadow: function (a, h, c) {
        ...
        if (!a) this.destroyShadows();
          ...
          c && (m(p, 'height', Math.max(m(p, 'height') - e, 0)), p.cutHeight = e),
          h ? h.element.appendChild(p) : q.parentNode.insertBefore(p, q),
          x.push(p);
          this.shadows = x
        }
        return this
    ...
    e(A.prototype, {
      ...
      applyEllipsis: function (a, h, c, w) {
        ...
        if (n = p > w) {
          for (; e <= b; ) q = Math.ceil((e + b) / 2),
          p = c.substring(0, q) + '…',
          d(p),
          p = this.getSpanWidth(a, h),
          e === b ? e = b + 1 : p > w ? b = q - 1 : e = q;
          0 === b && d('')
        }
        a.rotation = x;
        return n
      ...
      buildText: function (a) {
        ...
        if (t !== a.textCache) {
          ...
          q || B || D || f || - 1 !== p.indexOf(' ') ? (d = /<.*class="([^"]+)".*>/, n = /<.*style="([^"]+)".*>/, g = /<.*href="([^"]+)".*>/, z && z.appendChild(c), p = q ? p.replace(/<(b|strong)>/g, '<span style="font-weight:bold">').replace(/<(i|em)>/g, '<span style="font-style:italic">').replace(/<a/g, '<span').replace(/<\/(b|strong|i|em|a)>/g, '</span>').split(/<br.*?>/g) : [
            p
          ], p = y(p, function (a) {
            return '' !== a
          }), b(p, function (h, p) {
            ...
            b(q, function (h) {
              ...
              h || 1 === q.length) {
                ...
                g.test(h) && !x && (m(z, 'onclick', 'location.href="' + h.match(g) [1] + '"'), r(z, {
                  cursor: 'pointer'
                }));
                ...
                if (' ' !== h) {
                  ...
                  if (f) {
                    ...
                    P = K(z),
                    t = a.rotation;
                    for (D && (G = w.applyEllipsis(a, z, h, f)); !D && y && (b.length || B.length); ) a.rotation = 0,
                    N = w.getSpanWidth(a, z),
                    h = N > f,
                    void 0 === G && (G = h),
                    h && 1 !== b.length ? (z.removeChild(z.firstChild), B.unshift(b.pop())) : (b = B, B = [
                    ], b.length && !l && (z = k.createElementNS(O, 'tspan'), m(z, {
                      dy: P,
                      x: v
                    }), I && m(z, 'style', I), c.appendChild(z)), N > f && (f = N)),
                    b.length && z.appendChild(k.createTextNode(b.join(' ').replace(/- /g, '-')));
                    a.rotation = t
                  }
                  e++
                }
          ...
          }), G && a.attr('title', a.textStr), z && z.removeChild(c), B && a.applyTextOutline && a.applyTextOutline(B)) : c.appendChild(k.createTextNode(p.replace(/&lt;/g, '<').replace(/&gt;/g, '>')))
        }
      },
      ...
      symbol: function (a, h, c, w, p, q) {
        ...
        G ? (d = this.path(H), d.attr('fill', 'none'), e(d, {
          ...
          width: w,
          height: p
        }), q && e(d, q)) : g && (v = a.match(n) [1], d = this.image(v), d.imgwidth = L(Q[v] && Q[v].width, q && q.width), d.imgheight = L(Q[v] && Q[v].height, q && q.height), y = function () {
          d.attr({
            width: d.width,
            height: d.height
          })
      ...
      symbols: {
        ...
        arc: function (a, h, c, w, p) {
          ...
          e = p.end - 0.001;
          c = p.innerR;
          w = L(p.open, 0.001 > Math.abs(p.end - p.start - 2 * Math.PI));
          var d = Math.cos(q),
          n = Math.sin(q),
          g = Math.cos(e),
          e = Math.sin(e);
          p = 0.001 > p.end - q - Math.PI ? 0 : 1;
          b = [
            'M',
            a + b * d,
            h + x * n,
      ...
      text: function (a, h, c, w) {
        ...
        w || (a.xSetter = function (a, h, c) {
          ...
          q = c.getAttribute(h),
          b;
          for (b = 0; b < w.length; b++) p = w[b],
          p.getAttribute(h) === q && p.setAttribute(h, a);
          c.setAttribute(h, a)
        });
        return a
      },
  ...
  (function (a) {
    ...
    a.svg || (A = {
      ...
      pathToVML: function (a) {
        ...
        ]; c--; ) k(a[c]) ? b[c] = Math.round(10 * a[c]) - 5 : 'Z' === a[c] ? b[c] = 'x' : (b[c] = a[c], !a.isArc || 'wa' !== a[c] && 'at' !== a[c] || (b[c + 5] === b[c + 7] && (b[c + 7] += a[c + 7] > a[c + 5] ? 1 : - 1), b[c + 6] === b[c + 8] && (b[c + 8] += a[c + 8] > a[c + 6] ? 1 : - 1)));
        return b.join(' ') || 'x'
      },
      clip: function (a) {
        var c = this,
      ...
      shadow: function (a, b, e) {
        ...
        if (a) {
          f = v(a.width, 3);
          D = (a.opacity || 0.15) / f;
          for (q = 1; 3 >= q; q++) k = 2 * f + 1 - 2 * q,
          e && (H = this.cutOffPath(w.value, k + 0.5)),
          h = [
          ...
          F(d.prepVML(h), null, null, n),
          b ? b.element.appendChild(n) : p.parentNode.insertBefore(n, p),
          c.push(n);
          this.shadows = c
        }
        return this
      ...
      dashstyleSetter: function (a, b, e) {
        (e.getElementsByTagName('stroke') [0] || F(this.renderer.prepVML(['<stroke/>']), null, null, e)) [b] = a || 'solid';
        this[b] = a
      },
      dSetter: function (a, b, e) {
        ...
        if (c) for (e = c.length; e--; ) c[e].path = c[e].cutOff ? this.cutOffPath(a, c[e].cutOff) : a;
        this.setAttr(b, a)
      },
      ...
      color: function (c, b, e, d) {
        ...
        if (k) {
          ...
          if ('fill' === e) if ('gradient' === k) e = H.x1 || H[0] || 0,
          c = H.y1 || H[1] || 0,
          f = H.x2 || H[2] || 0,
          H = H.y2 || H[3] || 0,
          B = 'angle="' + (90 - 180 * Math.atan((H - c) / (f - e)) / Math.PI) + '"',
          m();
           else {
            var h = H.r,
            t = 2 * h,
            ...
            M,
            h = function () {
              E && (M = d.getBBox(), A += (E[0] - M.x) / M.width - 0.5, C += (E[1] - M.y) / M.height - 0.5, t *= E[2] / M.width, J *= E[2] / M.height);
              B = 'src="' + a.getOptions().global.VMLRadialGradientURL + '" size="' + t + ',' +
              J + '" origin="0.5,0.5" position="' + A + ',' + C + '" color2="' + r + '" ';
              m()
            };
            d.added ? h() : d.onAdd = h;
            h = x
      ...
      prepVML: function (a) {
        var c = this.isIE8;
        a = a.join('');
        c ? (a = a.replace('/>', ' xmlns="urn:schemas-microsoft-com:vml" />'), a = - 1 === a.indexOf('style="') ? a.replace('/>', ' style="display:inline-block;behavior:url(#default#VML);" />') :
  ...
  (function (a) {
    ...
    a.Tick.prototype = {
      ...
      handleOverflow: function (a) {
        ...
        if (e) 0 > e && m - v * y < k ? c = Math.round(m / Math.cos(e * l) - k) : 0 < e && m + v * y > d && (c = Math.round((g - m) / Math.cos(e * l)));
         else if (g = m + (1 - v) * y, m - v * y < k ? D = a.x + D * (1 - v) - k : g > d && (D = d - a.x + D * v, J = - 1), D = Math.min(n, D), D < n && 'center' === r.labelAlign && (a.x += J * (n - D - v * (n - Math.min(y, D)))), y > D || r.autoRotation && (b.styles || {
        }).width) c = D;
        c && (G.width = c, (r.options.labels.style || {
        }).textOverflow || (G.textOverflow = 'ellipsis'), b.css(G))
      },
      ...
      getLabelPosition: function (a, f, m, g, d, k, b, e) {
        ...
        c = d.y;
        A(c) || (c = 0 === v.side ?
        m.rotation ? - 8 : - m.getBBox().height : 2 === v.side ? r.y + 8 : Math.cos(m.rotation * l) * (r.y - m.getBBox(!1, 0).height / 2));
  ...
  var S = function (a) {
    ...
    a.extend(L.prototype, {
      ...
      setOptions: function (a) {
        this.options = c(this.defaultOptions, 'yAxis' === this.coll && this.defaultYAxisOptions, [
          this.defaultTopAxisOptions,
          this.defaultRightAxisOptions,
          this.defaultBottomAxisOptions,
          this.defaultLeftAxisOptions
        ][this.side], c(l[this.coll], a))
      },
      defaultLabelFormatter: function () {
        ...
        d = l.lang,
        n = d.numericSymbols,
        d = d.numericSymbolMagnitude || 1000,
        q = n && n.length,
        x,
        ...
        if (g) x = b(g, this);
         ...
         else if (q && 1000 <= h) for (; q-- && void 0 === x; ) e = Math.pow(d, q + 1),
        h >= e && 0 === 10 * c % e && null !== n[q] && 0 !== c && (x = a.numberFormat(c / e, - 1) + n[q]);
        void 0 === x && (x = 10000 <= Math.abs(c) ? a.numberFormat(c, - 1) : a.numberFormat(c, - 1, void 0, ''));
        return x
      },
      getSeriesExtremes: function () {
        ...
        g(a.series, function (h) {
          if (h.visible || !b.options.chart.ignoreHiddenSeries) {
            ...
            if (a.isXAxis) c = h.xData,
            c.length && (h = E(c), D(h) || h instanceof Date || (c = v(c, function (a) {
              return D(a)
            }), h = E(c)), a.dataMin = Math.min(B(a.dataMin, c[0]), h), a.dataMax = Math.max(B(a.dataMax, c[0]), F(c)));
             else if (h.getExtremes(), e = h.dataMax, h = h.dataMin, r(h) && r(e) && (a.dataMin = Math.min(B(a.dataMin, h), h), a.dataMax = Math.max(B(a.dataMax, e), e)), r(w) && (a.threshold = w), !c.softThreshold || a.positiveValuesOnly) a.softThreshold = !1
          }
        })
      },
      ...
      getPlotLinePath: function (a, b, c, e, p) {
        ...
        return f && !e ? null : h.renderer.crispLine(['M',
        a,
        n,
        'L',
        c,
      ...
      getMinorTickPositions: function () {
        ...
        if (q && q / e < a.len / 3) if (a.isLog) g(this.paddedTicks, function (h, b, c) {
         ...
         else for (b = n + (c[0] - n) % e; b <= d && b !== p[0]; b += e) p.push(b);
      ...
      adjustForMinRange: function () {
        ...
        this.isXAxis && void 0 === this.minRange && !this.isLog && (r(a.min) || r(a.max) ? this.minRange = null : (g(this.series, function (a) {
          k = a.xData;
          for (n = f = a.xIncrement ? 1 : k.length - 1; 0 < n; n--) if (q = k[n] - k[n - 1], void 0 === d || q < d) d = q
        }), this.minRange = Math.min(5 * d, this.dataMax - this.dataMin)));
        c - b < this.minRange && (p = this.dataMax - this.dataMin >= this.minRange, v = this.minRange, e = (v - c + b) / 2, e = [
          b - e,
          B(a.min, b - e)
        ], p && (e[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin), b = F(e), c = [
          b + v,
          B(a.max, b + v)
        ], p && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax), c = E(c), c - b < v && (e[0] = c - v, e[1] = B(a.min, c - v), b = F(e)));
        this.min = b;
        this.max = c
      },
      getClosest: function () {
      ...
      updateNames: function () {
        var a = this;
        0 < this.names.length && (this.names.length = 0, this.minRange = this.userMinRange, g(this.series || [
        ], function (h) {
          h.xIncrement = null;
      ...
      setAxisTranslation: function (a) {
        ...
        k = h.transA,
        f = h.isXAxis;
        if (f || q || c) e = h.getClosest(),
        n ? (p = n.minPointOffset, d = n.pointRangePadding) : g(h.series, function (a) {
          var b = q ? 1 : f ? B(a.options.pointRange, e, 0) : h.axisPointRange || 0;
          a = a.options.pointPlacement;
          c = Math.max(c, b);
          h.single || (p = Math.max(p, J(a) ? 0 : b / 2), d = Math.max(d, 'on' === a ? 0 : b))
        }),
        n = h.ordinalSlope && e ? h.ordinalSlope / e : 1,
        h.minPointOffset = p *= n,
        h.pointRangePadding = d *= n,
        h.pointRange = Math.min(c, b),
        f && (h.closestPointRange = e);
        a && (h.oldTransA = k);
      ...
      setTickInterval: function (h) {
        ...
        q || d || l || (b.tickInterval = G(b.tickInterval, null, e(b.tickInterval), B(p.allowDecimals, !(0.5 < b.tickInterval && 5 > b.tickInterval && 1000 < b.max && 9999 > b.max)), !!this.tickAmount));
      ...
      setTickPositions: function () {
        ...
        !b && (b = this.isDatetimeAxis ? this.getTimeTicks(this.normalizeTimeTickInterval(this.tickInterval, a.units), this.min, this.max, a.startOfWeek, this.ordinalPositions, this.closestPointRange, !0) : this.isLog ? this.getLogTickPositions(this.tickInterval, this.min, this.max) : this.getLinearTickPositions(this.tickInterval, this.min, this.max), b.length > this.len && (b = [
          b[0],
          b.pop()
        ]), this.tickPositions = b, e && (e = e.apply(this, [
          this.min,
          this.max
        ]))) && (this.tickPositions = b = e);
        this.paddedTicks = b.slice(0);
        this.trimTicks(b, p, d);
        this.isLinked || (this.single && 2 > b.length && (this.min -= 0.5, this.max += 0.5), c || e || this.adjustTickAmount())
      },
      trimTicks: function (a, b, c) {
        ...
        if (!this.isLinked) {
          ...
          if (c) this.max = e;
           else for (; this.max + p < a[a.length -
          1]; ) a.pop();
      ...
      zoom: function (a, b) {
        ...
        if (a !== this.min || b !== this.max) this.allowZoomOutside || (r(h) && (a < p && (a = p), a > e && (a = e)), r(c) && (b < p && (b = p), b > e && (b = e))),
      ...
      tickSize: function (a) {
        ...
        if (c && h) return 'inside' === b[a + 'Position'] && (h = - h),
        [
          h,
          c
        ]
      ...
      unsquish: function () {
        ...
        b ? (v = !a.staggerLines && !a.step && (r(n) ? [
          n
        ] : p < B(a.autoRotationLimit, 80) && a.autoRotation)) && g(v, function (a) {
          var b;
          if (a === n || a && - 90 <= a && 90 >= a) k = z(Math.abs(q.h / Math.sin(u * a))),
          b = k + Math.abs(a / 360),
          b < f && (f = b, d = a, e = k)
        }) :
        a.step || (e = z(q.h));
      ...
      getSlotWidth: function () {
        ...
        p = a.margin[3];
        return b && 2 > (c.step || 0) && !c.rotation && (this.staggerLines || 1) * this.len / e || !b && (p && p - a.spacing[3] || 0.33 * a.chartWidth)
      },
      renderUnsquish: function () {
        ...
        if (this.autoRotation) y > k && y > v.h ? f.rotation = this.labelRotation : this.labelRotation = 0;
          ...
          width: k + 'px'
        }, !z)) for (D.textOverflow = 'clip', l = e.length; !n && l--; ) if (I = e[l], k = p[I].label) k.styles && 'ellipsis' === k.styles.textOverflow ? k.css({
          textOverflow: 'clip'
        }) : p[I].labelLength >
        q && k.css({
          width: q + 'px'
        ...
        f.rotation && (D = {
          width: (y > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : a.chartHeight) + 'px'
      ...
      getOffset: function () {
        ...
        [
          k
        ] !== a.labelAlign && 'center' !== a.labelAlign || g(p, function (a) {
      ...
      getLinePath: function (a) {
        ...
        e ? h : this.top,
        'L',
        e ? b.chartWidth - this.right : p,
        e ? h : b.chartHeight - this.bottom], a)
      },
      renderLine: function () {
      ...
      getTitlePosition: function () {
        ...
        b = (a ? c + this.height : b) + (a ? 1 : - 1) * (n ? - 1 : 1) * this.axisTitleMargin + [ - f,
        f,
        v.f,
        - f][this.side];
        return {
      ...
      renderTick: function (a, b) {
        ...
        if (!c || a >= this.min && a <= this.max) e[a] || (e[a] = new I(this, a)),
        h && e[a].isNew && e[a].render(b, !0, 0.1),
        e[a].render(b)
      },
      render: function () {
        var b = this,
        ...
        k.length && (g(k, function (a, c) {
          b.renderTick(a, c)
        }), B && (0 === b.min || b.single) && (v[ - 1] || (v[ - 1] = new I(b, - 1, null, !0)), v[ - 1].render( - 1))),
        r && g(k, function (e, h) {
      ...
      drawCrosshair: function (a, b) {
        ...
        this.crosshair && !1 !== (r(b) || !h) ? (h ? r(b) && (p = this.isXAxis ? b.plotX : this.len - b.plotY) : p = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos), r(p) && (c = this.getPlotLinePath(b && (this.isXAxis ? b.x : B(b.stackY, b.y)), null, null, null, p) || null), r(c) ? (b = this.categories && !this.isRadial, d || (this.cross = d = this.chart.renderer.path().addClass('highcharts-crosshair highcharts-crosshair-' + (b ? 'category ' : 'thin ') + e.className).attr({
          ...
          stroke: e.color || (b ? m('#ccd6eb').setOpacity(0.25).get() : '#cccccc'),
  ...
  (function (a) {
    ...
    C.prototype.getTimeTicks = function (a, b, e, v) {
      ...
      if (m(b)) {
        ...
        var z = c[A.hcGetDate](),
        I = c[A.hcGetHours]();
        if (A.hcTimezoneOffset || A.hcGetTimezoneOffset) p = (!D || !!A.hcGetTimezoneOffset) && (e - b > 4 * d.month || u(b) !== u(e)),
        c = c.getTime(),
        t = u(c),
        c = new A(c + t);
        D = c.getTime();
        for (b = 1; D <
        e; ) k.push(D),
        D = q === d.year ? G(r + b * B, 0) : q === d.month ? G(r, v + b * B) : !p || q !== d.day && q !== d.week ? p && q === d.hour ? G(r, v, z, I + b * B, 0, 0, t) - t : D + q * B : G(r, v, z + b * B * (q === d.day ? 1 : 7)),
        b++;
        k.push(D);
        q <= d.hour && 10000 > k.length && f(k, function (a) {
          0 === a % 1800000 && '000000000' === F('%H%M%S%L', a) && (n[a] = 'day')
        })
      }
      k.info = l(a, {
        higherRanks: n,
  ...
  (function (a) {
    ...
    C.prototype.getLogTickPositions = function (a, l, r, u) {
      ...
      if (0.5 <= a) a = Math.round(a),
      b = this.getLinearTickPositions(a, l, r);
       else if (0.08 <= a) for (var g = Math.floor(l), e, v, y, n, D, f = 0.3 < a ? [
        1,
        2,
        4
      ] : 0.15 < a ? [
        ...
        8,
        9
      ]; g < r + 1 && !D; g++) for (v = f.length, e = 0; e < v && !D; e++) y = k(d(g) * f[e]),
      y > l && (!u || n <= r) && void 0 !== n && b.push(n),
      n > r && (D = !0),
      n = y;
       else l = d(l),
      r = d(r),
      a = f[u ? 'minorTickInterval' : 'tickInterval'],
      a = m('auto' === a ? null : a, this._minorAutoInterval, f.tickPixelInterval / (u ? 5 : 1) * (r - l) / ((u ? g / this.tickPositions.length :
      g) || 1)),
      a = E(a, null, A(a)),
      b = F(this.getLinearTickPositions(a, l, r), k),
  ...
  (function (a, C) {
    ...
    a.extend(C.prototype, {
      ...
      addPlotBandOrLine: function (f, g) {
        ...
        k = this.userOptions;
        d && (g && (k[g] = k[g] || [
        ], k[g].push(f)), this.plotLinesAndBands.push(d));
        return d
      },
  ...
  (function (a) {
    ...
    a.Tooltip.prototype = {
      ...
      move: function (a, k, b, e) {
        var d = this,
        g = d.now,
        n = !1 !== d.options.animation && !d.isHidden && (1 < Math.abs(a - g.x) || 1 < Math.abs(k -
        g.y)),
      ...
      getAnchor: function (a, k) {
        ...
        a = u(a);
        b = a[0].tooltipPos;
        this.followPointer && k && (void 0 === k.chartX && (k = e.pointer.normalize(k)), b = [
          k.chartX - e.plotLeft,
          k.chartY - g
        ]);
        b || (A(a, function (a) {
        ...
        }), l /= a.length, m /= a.length, b = [
          d ? e.plotWidth - m : l,
          this.shared && !d && 1 < a.length && k ? k.chartY - g : d ? e.plotHeight - l : m
        ]);
      ...
      defaultFormatter: function (a) {
        ...
        b;
        b = [
          a.tooltipFooterHeaderFormatter(d[0])
        ];
    ...
    a.Pointer.prototype = {
      ...
      runPointActions: function (b, e) {
        ...
        if (n && (n !== d.hoverPoint || c && c.isHidden)) {
          ...
          d.hoverPoint = n;
          c && c.refresh(g ? v : n, b)
        } else e && c && !c.isHidden && (n = c.getAnchor([{
        }
        ], b), c.updatePosition({
          plotX: n[0],
          plotY: n[1]
  ...
  (function (a) {
    ...
    F(a.Pointer.prototype, {
      ...
      pinchTranslateDirection: function (a, f, m, t, g, d, k, b) {
        ...
        w ? (I -= 0.8 * (I - k[v][0]), p || (h -= 0.8 * (h - k[v][1])), m()) : k[v] = [
          I,
          h
        ];
        B || (d[v] = G - u, d[r] = c);
  ...
  (function (a) {
    ...
    if (!a.hasTouch && (u.PointerEvent || u.MSPointerEvent)) {
      ...
      b = function (b, d, g, n) {
        'touch' !== b.pointerType && b.pointerType !== b.MSPOINTER_TYPE_TOUCH || !A[a.hoverChartIndex] || (n(b), n = A[a.hoverChartIndex].pointer, n[d]({
          type: g,
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      adjustMargins: function (a, e) {
        ...
        d.floating || m([/(lth|ct|rth)/,
        /(rtv|rm|rbv)/,
        /(rbh|cb|lbh)/,
        /(lbv|lm|ltv)/], function (f, k) {
          f.test(g) && !E(a[k]) && (b[l[k]] = Math.max(b[l[k]], b.legend[(k + 1) % 2 ? 'legendHeight' : 'legendWidth'] + [1,
          - 1,
          - 1,
          1][k] * d[k % 2 ? 'x' : 'y'] + u(d.margin, 12) + e[k]))
        })
      },
      render: function () {
        var a = this,
      ...
      handleOverflow: function (a) {
        ...
        a > d && !1 !== q.enabled ? (this.clipHeight = c = Math.max(d - 20 - this.titleHeight - l, 0), this.currentPage = u(this.currentPage, 1), this.fullHeight = a, m(L, function (a, b) {
          ...
          var d = z.length;
          if (!d || e - z[d - 1] > c && (I || e) !== z[d - 1]) z.push(I || e),
          d++;
    ...
    a.LegendSymbolMixin = {
      ...
      drawLineMarker: function (a) {
        ...
        this.legendLine = l.path(['M',
        0,
        a,
        'L',
        g,
        a]).addClass('highcharts-graph').attr(m).add(c);
  ...
  (function (a) {
    ...
    b(R.prototype, {
      ...
      redraw: function (c) {
        ...
        this.layOutTitles();
        for (c = d.length; c--; ) if (z = d[c], z.options.stacking && (f = !0, z.isDirty)) {
          q = !0;
          break
        }
        if (q) for (c = d.length; c--; ) z = d[c],
        z.options.stacking && (z.isDirty = !0);
        k(d, function (a) {
      ...
      get: function (a) {
        ...
        for (h = 0; !c && h < d.length; h++) c = e(d[h].points || [
        ], b);
        return c
      },
      getAxes: function () {
      ...
      temporaryDisplay: function (b) {
        ...
        c.hcOrigDetached && (m.body.removeChild(c), c.hcOrigDetached = !1),
        c = c.parentNode;
         else for (; c && c.style; ) {
      ...
      reflow: function (a) {
        ...
        if (!h && !b.isPrinting && p && c && (e === O || e === m)) {
          if (p !== b.containerWidth || c !== b.containerHeight) clearTimeout(b.reflowTimeout),
      ...
      drawChartBox: function () {
        ...
        if (g || d['stroke-width']) k.stroke = a.borderColor,
        k['stroke-width'] = g;
      ...
      onload: function () {
        k([this.callback].concat(this.callbacks), function (a) {
          a && void 0 !== this.index && a.apply(this, [
            this
          ])
        }, this);
        v(this, 'load');
  ...
  (function (a) {
    ...
    a.Point.prototype = {
      ...
      optionsToObject: function (a) {
        ...
        m = 0,
        n = 0;
        if (r(a) || null === a) d[e[0]] = a;
         else if (l(a)) for (!b && a.length > f && (g = typeof a[0], 'string' === g ? d.name = a[0] : 'number' ===
        g && (d.x = a[0]), m++); n < f; ) b && void 0 === a[m] || (d[e[n]] = a[m]),
        m++,
        n++;
  ...
  (function (a) {
    ...
    a.Series = a.seriesType('line', null, {
      ...
      insert: function (a) {
        ...
        c;
        if (v(b)) {
          for (c = a.length; c--; ) if (b >= J(a[c].options.index, a[c]._i)) {
            a.splice(c + 1, 0, this);
            break
          }
          - 1 === c && a.unshift(this);
      ...
      setData: function (b, c, d, f) {
        ...
        if (!1 !== f && k && g === k && !h.cropped && !h.hasGroupedData && h.visible) t(b, function (a, b) {
          ...
          if (z && k > z) {
            for (d = 0; null === n && d < k; ) n = b[d],
            d++;
            if (v(n)) for (d = 0; d < k; d++) r[d] = this.autoIncrement(),
            B[d] = b[d];
             else if (e(n)) if (I) for (d = 0; d < k; d++) n = b[d],
            r[d] = n[0],
            B[d] = n.slice(1, I + 1);
             else for (d = 0; d < k; d++) n = b[d],
            r[d] = n[0],
            B[d] = n[1];
             else a.error(12)
          } else for (d = 0; d < k; d++) void 0 !== b[d] && (n = {
            series: h
          }, h.pointClass.prototype.applyOptions.apply(n, [
            b[d]
          ]), h.updateParallelArrays(n, d));
          y(B[0]) && a.error(14, !0);
          h.data = [
          ];
      ...
      processData: function (b) {
        ...
        if (l && this.sorted && !n && (!k || d > k || this.forceCrop)) if (c[d - 1] < v || c[0] > r) c = [
        ],
        e = [
        ];
         else if (c[0] < v || c[d - 1] > r) h = this.cropData(this.xData, this.yData, v, r),
        c = h.xData,
        e = h.yData,
        h = h.start,
        p = !0;
        for (k = c.length || 1; --k; ) d = m ? q(c[k]) - q(c[k - 1]) : c[k] - c[k - 1],
        0 < d && (void 0 === f || d < f) ? f = d : 0 > d && this.requireSorting && a.error(15);
        this.cropped = p;
        this.cropStart = h;
      ...
      generatePoints: function () {
        ...
        r;
        c || l || (c = [
        ], c.length = b.length, c = this.data = c);
        a && l && (this.options.keys = !1);
        for (r = 0; r < k; r++) n = q + r,
        l ? (m = (new f).init(this, [
          d[r]
        ].concat(G(g[r]))), m.dataGroup = this.groupMap[r]) : (m = c[n]) || void 0 === b[n] || (c[n] = m = (new f).init(this, b[n], d[r])),
        m && (m.index = n, v[r] = m);
        this.options.keys = a;
        if (c && (k !== (e = c.length) || l)) for (r = 0; r < e; r++) r !== q || l || (r += k),
      ...
      getExtremes: function (a) {
        ...
        d = a.length;
        for (l = 0; l < d; l++) if (q = c[l], n = a[l], k = (v(n, !0) || e(n)) && (!b.positiveValuesOnly || n.length || 0 < n), q = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[l] || q) >= g && (c[l] || q) <= f, k && q) if (k = n.length) for (; k--; ) null !== n[k] && (h[p++] = n[k]);
         else h[p++] = n;
        this.dataMin = E(h);
        this.dataMax = F(h)
      },
      translate: function () {
        ...
        for (a = 0; a < f; a++) {
          ...
          K.plotX = B = m(Math.min(Math.max( - 100000, c.translate(A, 0, 0, 0, 1, q, 'flags' === this.type)), 100000));
          ...
          K.plotY = y = 'number' === typeof C && Infinity !== C ? Math.min(Math.max( - 100000, d.translate(C, 0, 1, 0, 1)), 100000) : void 0;
      ...
      drawPoints: function () {
        ...
        if (!1 !== g.enabled || this._hasPointMarkers) for (e = 0; e < a.length; e++) d = a[e],
        c = d.plotY,
        f = d.graphic,
        k = d.marker || {
        },
        q = !!d.marker,
        n = r && void 0 === k.enabled || k.enabled,
        l = d.isInside,
        n && v(c) && null !== d.y ? (c = J(k.symbol, this.symbol), d.hasImage = 0 === c.indexOf('url'), n = this.markerAttribs(d, d.selected && 'select'), f ? f[l ? 'show' : 'hide'](!0).animate(n) : l && (0 < n.width || d.hasImage) && (d.graphic = f = b.renderer.symbol(c, n.x, n.y, n.width, n.height, q ? k : g).add(m)), f && f.attr(this.pointAttribs(d, d.selected && 'select')), f && f.addClass(d.getClassName(), !0)) : f && (d.graphic = f.destroy())
      },
      ...
      pointAttribs: function (a, b) {
        ...
        }, e = J(b.lineWidth, c.lineWidth, e + J(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, f = b.lineColor || c.lineColor || f);
        return {
          stroke: f,
          'stroke-width': e,
          fill: a
      ...
      getGraphPath: function (a, b, c) {
        ...
        t(a, function (h, g) {
          ...
          h.isNull && !u(b) && 0 < g ? q = !d.connectNulls : h.isNull && !b ? q = !0 : (0 === g || q ? g = [
            'M',
            h.plotX,
            h.plotY
          ] : e.getPointSpline ?
          g = e.getPointSpline(a, h, g) : f ? (g = 1 === f ? [
            'L',
            m.plotX,
            l
          ] : 2 === f ? [
            ...
            n,
            l
          ], k.push(h.x), f && k.push(h.x), p.push.apply(p, g), q = !1)
        });
        p.xMap = k;
      ...
      drawGraph: function () {
        ...
        t(this.zones, function (c, d) {
          e.push(['zone-graph-' + d,
          'highcharts-graph highcharts-zone-graph-' + d + ' ' + (c.className || ''),
          c.color || a.color,
      ...
      buildKDTree: function () {
        function a(c, e, d) {
          var h,
          f;
          if (f = c && c.length) return h = b.kdAxisArray[e % d],
          c.sort(function (a, b) {
            return a[h] - b[h]
          }),
          f = Math.floor(f / 2),
  ...
  (function (a) {
    ...
    a.StackItem.prototype = {
      ...
      setOffset: function (a, d) {
        ...
        if (d = this.label) d.align(this.alignOptions, null, e),
        e = d.alignAttr,
        d[!1 === this.options.crop || b.isInsidePlot(e.x, e.y) ? 'show' : 'hide'](!0)
      },
    ...
    t.prototype.setStackedPoints = function () {
      if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        ...
        for (A = 0; A < b; A++) h = f[A],
        w = d[A],
        K = this.getStackIndicator(K, h, this.index),
        I = K.key,
        z = (p = c && w < (m ? 0 : l)) ? t : r,
        q[z] || (q[z] = {
        }),
        q[z][h] || (B[z] && B[z][h] ? (q[z][h] = B[z][h], q[z][h].total = null) : q[z][h] = new a.StackItem(G, G.options.stackLabels, p, h, n)),
        z = q[z][h],
        null !== w && (z.points[I] = z.points[this.index] = [
          u(z.cum, m)
        ], E(z.cum) || (z.base = I), z.touched = G.stacksTouched, 0 < K.index && !1 === this.singleStacks && (z.points[I][0] = z.points[this.index + ',' + h + ',0'][0])),
        'percent' === e ? (p = p ? r : t, c && q[p] && q[p][h] ? (p = q[p][h], z.total = p.total = Math.max(p.total, z.total) + Math.abs(w) || 0) : z.total = F(z.total + (Math.abs(w) || 0))) : z.total = F(z.total + (w || 0)),
        z.cum = u(z.cum, m) + (w || 0),
        null !== w && (z.points[I].push(z.cum), k[A] = z.cum);
    ...
    t.prototype.setPercentStacks = function () {
      ...
      f([d,
      '-' + d], function (d) {
        for (var f = b.length, g, l; f--; ) if (g = b[f], e = a.getStackIndicator(e, g, a.index, d), g = (l = k[d] && k[d][g]) && l.points[e.key]) l = l.total ? 100 / l.total : 0,
        g[0] = F(g[0] * l),
        g[1] = F(g[1] * l),
  ...
  (function (a) {
    ...
    u(a.Chart.prototype, {
      ...
      update: function (a, b, c) {
        ...
        if (q) {
          ...
          if ('inverted' in q || 'polar' in q) k.propFromSeries(),
          m = !0;
          'alignTicks' in q && (m = !0);
          v(q, function (a, b) {
        ...
        l('xAxis yAxis zAxis series colorAxis pane'.split(' '), function (b) {
          a[b] && (l(G(a[b]), function (a, e) {
            ...
            if (!e && c) if ('series' === b) k.addSeries(a, !1).touched = !0;
    ...
    u(D.prototype, {
      addPoint: function (a, b, c, e) {
        ...
        m = p.x;
        n = q.length;
        if (this.requireSorting && m < q[n - 1]) for (l = !0; n && q[n - 1] > m; ) n--;
    ...
    f('area', 'line', {
      ...
      getStackPoints: function (f) {
        ...
        if (this.options.stacking) {
          for (D = 0; D < f.length; D++) k[f[D].x] = f[D];
          ...
          A(m, function (a, c) {
            ...
            f,
            r;
            if (k[a] && !k[a].isNull) l.push(k[a]),
            A([ - 1,
            1], function (e) {
              var g = 1 === e ? 'rightNull' : 'leftNull',
              l = 0,
              q = d[m[c + e]];
              if (q) for (D = b; 0 <= D && D < v; ) f = q.points[D],
              f || (D === b ? k[a][g] = !0 : y[D] && (r = d[a].points[D]) && (l -= r[1] - r[0])),
              D += n;
      ...
      getGraphPath: function (a) {
        ...
        for (d = 0; d < a.length; d++) if (k = a[d].isNull, y = E(a[d].rectPlotX, a[d].plotX), c = E(a[d].yBottom, A), !k || l) l || G(d, d - 1, 'left'),
        k && !t && l || (e.push(a[d]), b.push({
          x: d,
          plotX: y,
          plotY: c
        })),
      ...
      drawGraph: function () {
        ...
        A(this.zones, function (f, d) {
          t.push(['zone-area-' + d,
          'highcharts-area highcharts-zone-area-' + d + ' ' + f.className,
          f.color || a.color,
          f.fillColor || u.fillColor])
        });
        A(t, function (g) {
          var d = g[0],
          k = a[d];
          k ? (k.endX = f.xMap, k.animate({
            ...
            fill: E(g[3], C(g[2]).setOpacity(E(u.fillOpacity, 0.75)).get()),
            zIndex: 0
  ...
  (function (a) {
    ...
    a('spline', 'line', {
      ...
      getPointSpline: function (a, F, E) {
        ...
        F = [
          'C',
          C(l.rightContX, l.plotX),
          C(l.rightContY, l.plotY),
          C(r, m),
          C(u, f),
          m,
          f
    ...
    u('column', 'line', {
      ...
      translate: function () {
        ...
        F(a.points, function (b) {
          ...
          b.shapeType = 'rect';
          b.shapeArgs = a.crispCol.apply(a, b.isNull ? [
            k,
            m,
            n,
            0
      ...
      pointAttribs: function (a, d) {
        ...
        d && (a = f(g.states[d], a.options.states && a.options.states[d] || {
        }), d = a.brightness, m = a.color || void 0 !== d && A(m).brighten(a.brightness).get() || m, n = a[b] || n, r = a[l] || r, e = a.dashStyle || e);
        b = {
          fill: m,
          stroke: n,
          'stroke-width': r
      ...
      animate: function (a) {
        ...
        t && (a ? (g.scaleY = 0.001, a = Math.min(f.pos + f.len, Math.max(f.pos, f.toPixels(b.threshold))), e ? g.translateX = a - f.len : g.translateY = a, d.group.attr(g)) : (g[e ? 'translateX' : 'translateY'] = f.pos, d.group.animate(g, E(C(d.options.animation), {
          step: function (a, b) {
            d.group.attr({
  ...
  (function (a) {
    ...
    t('pie', 'line', {
      ...
      updateTotals: function () {
        ...
        for (a = 0; a < e; a++) g = b[a],
        f += l && !g.visible ? 0 : g.isNull ? 0 : g.y;
        this.total = f;
        for (a = 0; a < e; a++) g = b[a],
        g.percentage = 0 < f && (g.visible || !l) ? g.y / f * 100 : 0,
        g.total = f
      },
      generatePoints: function () {
      ...
      translate: function (a) {
        ...
        for (u = 0; u < p; u++) {
          ...
          z.shapeArgs = {
            ...
            r: a[2] / 2,
            innerR: a[3] / 2,
            start: Math.round(1000 * g) / 1000,
            end: Math.round(1000 * n) / 1000
          };
          m = (n + g) / 2;
          ...
          z.labelPos = [
            a[0] + n + Math.cos(m) * z.labelDistance,
            a[1] + q + Math.sin(m) * z.labelDistance,
            a[0] + n + Math.cos(m) * g,
            a[1] + q + Math.sin(m) * g,
            a[0] + n,
            a[1] + q,
            0 > z.labelDistance ? 'center' : z.half ? 'right' : 'left',
            m
          ]
        }
      },
      ...
      setVisible: function (a, f) {
        ...
        f = l(f, g);
        a !== b.visible && (b.visible = b.options.visible = a = void 0 === a ? !b.visible : a, e.options.data[m(b, e.data)] = b.options, F(['graphic',
        'dataLabel',
        'connector',
        'shadowGroup'], function (e) {
  ...
  (function (a) {
    ...
    a.distribute = function (a, d) {
      ...
      for (a = l(a, function (a) {
        ...
        for (f = a.length; f--; ) g = a[f],
        m = (Math.min.apply(0, g.targets) + Math.max.apply(0, g.targets)) / 2,
        g.pos = Math.min(Math.max(0, m - g.size / 2), d - g.size);
        f = a.length;
        for (g = !1; f--; ) 0 < f && a[f - 1].pos + a[f - 1].size > a[f].pos && (a[f - 1].size += a[f].size, a[f - 1].targets = a[f - 1].targets.concat(a[f].targets), a[f - 1].pos + a[f - 1].size > d && (a[f - 1].pos = d - a[f - 1].size), a.splice(f, 1), g = !0)
      }
      f = 0;
      E(a, function (a) {
        var b = 0;
    ...
    d.prototype.drawDataLabels = function () {
      ...
      A = b.chart.renderer;
      if (g.enabled || b._hasPointLabels) b.dlProcessOptions && b.dlProcessOptions(g),
      q = b.plotGroup('dataLabelsGroup', 'data-labels', B && !c ? 'hidden' : 'visible', g.zIndex || 6),
      B && (q.attr({
        opacity: + c
      ...
      E(k, function (c) {
        ...
        if (e = t(l && l.enabled, m.enabled) && null !== c.y) g = r(m, l),
        n = c.getLabelConfig(),
        u = g.format ? f(g.format, n) : g.formatter.call(n, g),
        B = g.style,
        n = g.rotation,
        B.color = t(g.color, B.color, b.color, '#000000'),
        'contrast' === B.color && (c.contrastColor = A.getContrast(c.color || b.color), B.color = g.inside || 0 > t(c.labelDistance, g.distance) || d.stacking ? c.contrastColor : '#000000'),
        d.cursor && (B.cursor = d.cursor),
        h = {
    ...
    k.pie && (k.pie.prototype.drawDataLabels = function () {
      ...
      b.visible && (l.enabled || b._hasPointLabels) && (E(f, function (a) {
        ...
        u;
        if (n) for (b.sortByAngle(c, d - 0.5), 0 < b.maxLabelDistance && (e = Math.max(0, z - p - b.maxLabelDistance), f = Math.min(z + p + b.maxLabelDistance, k.plotHeight), E(c, function (a) {
        ...
        }), a.distribute(v, f + u - e)), R = 0; R < n; R++) g = c[R],
        f = g.positionsIndex,
        h = g.labelPos,
        I = g.dataLabel,
        Q = !1 === g.visible ? 'hidden' : 'inherit',
        e = h[1],
        v && F(v[f]) ? void 0 === v[f].pos ? Q = 'hidden' : (w = v[f].size, O = g.top + v[f].pos) : O = e,
        delete g.positionIndex,
        H = l.justify ? C[0] + (d ? - 1 : 1) * (p + g.labelDistance) : b.getX(O < g.top + 2 || O > g.bottom - 2 ? e : O, d, g),
        I._attr = {
          visibility: Q,
          align: h[6]
        },
        ...
        h.x = H,
        h.y = O,
        t(l.crop, !0) && (L = I.getBBox().width, e = null, H - L < m ? (e = Math.round(L - H + m), x[3] = Math.max(e, x[3])) : H + L > r - m && (e = Math.round(H + L - r + m), x[1] = Math.max(e, x[1])), 0 > O - w / 2 ? x[0] = Math.max(Math.round( - O + w / 2), x[0]) : O + w / 2 > q && (x[2] = Math.max(Math.round(O + w / 2 - q), x[2])), I.sideOverflow = e)
        ...
        if ((I = a.dataLabel) && I._pos && a.visible && 0 < a.labelDistance) {
          ...
          if (e = !u) a.connector = u = k.renderer.path().addClass('highcharts-data-label-connector highcharts-color-' + a.colorIndex).add(b.dataLabelsGroup),
          u.attr({
            'stroke-width': c,
  ...
  (function (a) {
    ...
    J = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        ...
        d = b.trackByArea,
        e = [
        ].concat(d ? a.areaPath : a.graphPath),
        f = e.length,
        g = a.chart,
        k = g.pointer,
        m = g.renderer,
        ...
        v = 'rgba(192,192,192,' + (D ? 0.0001 : 0.002) + ')';
        if (f && !d) for (r = f + 1; r--; ) 'M' === e[r] && e.splice(r + 1, 0, e[r + 1] - n, e[r + 2], 'L'),
        (r && 'M' === e[r] || r === f) && e.splice(r, 0, 'L', e[r - 2] + n, e[r - 1]);
        h ? h.attr({
          d: e
    ...
    r(v.prototype, {
      ...
      setState: function (a, b) {
        ...
        if (!(a === this.state && !b || this.selected && 'select' !== a || !1 === k.enabled || a && (h || m && !1 === n.enabled) || a && u.states && u.states[a] && !1 === u.states[a].enabled)) {
          ...
          this.graphic.animate(g.pointAttribs(this, a), e(v.options.chart.animation, k.animation)),
          A && this.graphic.animate(A, e(v.options.chart.animation, n.animation, l.animation)),
          t && t.hide();
           else {
            if (a && n) {
              l = u.symbol || g.symbol;
    ...
    r(y.prototype, {
      ...
      setState: function (a) {
        ...
        c = 0;
        a = a || '';
        if (b.state !== a && (l([b.group,
        b.markerGroup,
        b.dataLabelsGroup], function (c) {
          ...
          'stroke-width': g
        }, d.animate(g, e(b.chart.options.chart.animation, f[a] && f[a].animation)); b['zone-graph-' + c]; ) b['zone-graph-' + c].attr(g),
        c += 1
      },
    ...
    C.prototype.currentOptions = function (f) {
      function r(f, d, k, b) {
        ...
        a.objectEach(f, function (a, g) {
          ...
          ], e = 0; e < f[g].length; e++) d[g][e] && (k[g][e] = {
          }, r(a[e], d[g][e], k[g][e], b + 1));
           else m(a) ? (k[g] = E(a) ? [
          ] : {
          }, r(a, d[g] || {
          }, k[g], b + 1)) : k[g] = d[g] || null
        })
      }
      var t = {
      };
